...
- (void)drawRect:(NSRect)rect {
	...
	if(_animatingAlternateImage) {
        ...
        [[self alternateImage] drawInRect:drawRect fromRect:NSZeroRect operation:NSCompositingOperationSourceOver fraction:sin(_animationValue * M_PI) respectFlipped:YES hints:nil];
	}
}
